        ...
        <div class="card-body">
          <h4 class="card-title">
            <a href="{{route('dashboard')}}">
              <span><i class="fas fa-arrow-left mr-3"></i>Data Pengajuan Izin</span>
            </a>
            <div class="pull-right">
              ...
              <button class="btn btn-primary btn-sm" wire:click="{{$modal ? 'showModal' : 'toggleForm(true)'}}"><i class="fas fa-plus"></i>
                Tambah Data Pengajuan Izin</button>
              @endif
            </div>
          </h4>
        </div>
      ...
      <div class="modal-dialog" permission="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="my-modal-title">{{$update_mode ? 'Edit':'Tambah'}} Pengajuan Izin
            </h5>
          </div>
          <div class="modal-body">
            ...
            <x-text-field type="date" name="tanggal_izin" label="Tanggal Izin" />
            <x-text-field type="text" name="alasan_izin" label="Alasan Izin" />
            @if ($this->update_mode)
